...
export default function App() {
  ...
  ////Use Effect render Teszt amikor a kereső mezőbe beírok valamit mikor melyik milyen sorrendben fut le.
  // useEffect(function () {
  ...
  // // Ha render Logikába, State-tet állítunk be végtelenül elkezd requestet küldeni a React működése miatt, hiszen a State állítás rerenderelést vált ki nem szabad
  // // useEffect hook-on belül kell használni
  // fetch(`http://www.omdbapi.com/?apikey=${KEY}&s=interstellar`)
  //   .then((res) => res.json())
  //   // .then((data) => setMovies(data.Search)); => Ezt nem szabad csak így
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  useEffect(
    // -Mindig hozzáad még egy eventlistenert így többször hívodik meg stackelődik, ebben a formában.
    //   function () {
